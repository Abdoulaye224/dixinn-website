    ...
    <div className="container mx-auto px-6 py-24 md:py-32 relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-4 auto-rows-[280px]">
        ...
        <motion.div
          ...
          className="col-span-1 md:col-span-6 lg:col-span-5 group relative rounded-2xl bg-card border border-border overflow-hidden hover:border-border transition-colors p-8 flex flex-col justify-between"
        >
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="px-2 py-0.5 rounded text-[10px] font-mono uppercase tracking-wider bg-foreground/10 text-foreground">
                Hyperviseur
              </span>
            </div>
        ...
        <motion.div
          ...
          className="col-span-1 md:col-span-6 lg:col-span-7 group relative rounded-2xl bg-card border border-border overflow-hidden hover:border-border transition-colors p-8 flex flex-col justify-between"
        >
        ...
        <motion.div
          ...
          className="col-span-1 md:col-span-4 lg:col-span-4 group relative rounded-2xl bg-card border border-border overflow-hidden hover:border-border transition-colors p-8 flex flex-col justify-between"
        >
          <div className="w-12 h-12 rounded-lg bg-foreground/5 border border-foreground/10 flex items-center justify-center text-foreground mb-6">
        ...
        <motion.div
          ...
          className="col-span-1 md:col-span-4 lg:col-span-4 relative rounded-2xl bg-foreground/[0.01] border border-dashed border-border overflow-hidden p-8 flex flex-col justify-between opacity-80"
        >
          <div className="w-12 h-12 rounded-lg bg-foreground/5 flex items-center justify-center text-muted-foreground mb-6">
